class CourseRequestsController < ApplicationController
  ...
  private
    ...
    def course_request_params
      params.require(:course_request).permit(:course_name, :description, :training_method, :training_category, :tuition_cost, :planned_travelcost, :actual_travelcost, :total_cost, :location, :training_date, :completion_status, :approval_status)
      #params.permit(:course_name, :description, :training_method, :training_category, :tuition_cost, :planned_travelcost, :actual_travelcost, :total_cost, :location, :training_date, :completion_status, :approval_status)
    end
end
